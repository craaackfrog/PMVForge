...
def main():
    ...
    quality_group.add_argument('-fps',         metavar="FPS",              default=30, help='Output video FPS', type=int, widget='IntegerField')
    quality_group.add_argument('-resolution',  metavar="Resolution",       default='1920:1080', help='Output video Resolution')
    quality_group.add_argument('-bitrate',     metavar="Bit rate",         default='10M', help='Output video bitrate, higher numer is higher quality')
    
    performance_group = parser.add_argument_group("Performance Options")
    performance_group.add_argument('-batch',       metavar="Batch size",       default=1, type=int, help='How many clips to split per thread', widget='IntegerField')
